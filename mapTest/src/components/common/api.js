...
export const submit = params => {
	return addHeader(axios.post,  window.__config.apiServer + `/mapspot/submit`, params).then(res => res.data);
};
...
export const reject = params => {
	return addHeader(axios.post,  window.__config.apiServer + `/mapspot/reject`, params).then(res => res.data);
};

export const fetchList = params => { 
	return addHeader(axios.post,  window.__config.apiServer + `/mapspot/list`, params).then(res => res.data);
	//return getWithHeader(axios.get,  window.__config.apiServer + `/mapspot/list`, params).then(res => res.data);
};
